	...
	<div id="footer">
		<p><strong><?php bloginfo('name')?></strong> <a href="<?php bloginfo('rss2_url') ?>">(RSS)</a> + <strong>Satorii-Min</strong> theme by <a href="http://www.markphilpot.net">Mark Philpot</a></p>
